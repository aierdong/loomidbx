...
- [ ] 6.7 Schema Trust 门禁契约测试：`trusted` 状态下各核心接口成功路径 JSON 结构。
  ...
  - _Requirements: 3.4, 4.1, 5.3_
- [ ] 6.8 Schema Trust 门禁契约测试：`pending_rescan` 状态下失败/只读例外 JSON 结构。
  ...
  - _Requirements: 3.4, 4.1, 5.3_
- [ ] 6.9 Schema Trust 门禁契约测试：`pending_adjustment` 状态下失败/只读例外 JSON 结构。
